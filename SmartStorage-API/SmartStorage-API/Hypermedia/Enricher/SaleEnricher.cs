...
{
    public class SaleEnricher : ContentResponseEnricher<SaleVO>
    {
        private readonly object _lock = new object();

        protected override Task EnrichModel(SaleVO content, IUrlHelper urlHelper)
        {
            var path = "storage/sales/v1";
